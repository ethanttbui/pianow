...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class Draggable : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler
    {
        /// <summary>
        ...
        private void UpdateDragging()
        {
            ...
            // Keep the hologram upright
            if (RotationMode == RotationModeEnum.OrientTowardUserAndKeepUpright || RotationMode == RotationModeEnum.Default)
            {
